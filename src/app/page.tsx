        ...
        <div className="flex-1">
          <div className="w-full rounded-lg bg-gradient-to-br from-primary/20 to-primary/10 p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              <li>• 120 pegawai mendekati kenaikan pangkat (3 bulan)</li>
              <li>• 18 dokumen belum lengkap</li>
              <li>• 4 OPD terkoneksi</li>
            </ul>
            <div className="mt-6">
              <Link href="/rsud" className="inline-block bg-primary text-background px-4 py-2 rounded-md">Dashboard</Link>
            </div>
          </div>
        </div>
      </section>
