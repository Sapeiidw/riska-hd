        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
              <li>Data identitas (nama, email)</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
              ...
              <li>Mengirimkan notifikasi penting</li>
              <li>Keperluan keamanan dan pencegahan fraud</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              untuk melindungi data Anda, termasuk enkripsi data, kontrol akses
              berbasis peran, pencatatan aktivitas sistem, dan backup data
              berkala. Akses terhadap data dibatasi hanya untuk personel yang
              berwenang.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              diwajibkan oleh hukum atau peraturan yang berlaku, atau dengan
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">7. Kontak</h2>
            <p className="text-gray-600 leading-relaxed">
